      ...
      <div className="pt-20 pb-20 grid grid-flow-col gap-16 justify-center">
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div className="px-6 py-4 flex flex-col justify-center">
            <div className="font-bold text-xl mb-2 flex justify-center">Mes services périnat'</div>
        ...
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div className="px-6 py-4 flex flex-col justify-center">
            <div className="font-bold text-xl mb-2 flex justify-center">Mes services Doula</div>
            <p className="text-gray-700 text-justify">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Voluptatibus quia, nulla! Maiores et perferendis eaque,
              exercitationem praesentium nihil.
        ...
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div className="px-6 py-4 flex flex-col justify-center">
            <div className="font-bold text-xl mb-2 flex justify-center">Service Ohmamacare</div>
            <p className="text-gray-700 text-justify">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Voluptatibus quia, nulla! Maiores et perferendis eaque,
              exercitationem praesentium nihil.
