...
export default function Footer() {
  return (
    <footer
      ...
      className="text-center grid grid-cols-5 pb-12"
    >
      <div className="flex justify-center">
        <ul className="text-left" style={{ color: "#bd897d" }}>
          <li>Accueil</li>
          <li>Présentations</li>
          <li>Prestations</li>
          <li>Forfaits</li>
      ...
      <div className="text-center">
        <p style={{ color: "#bd897d" }}>Leslie RICHARD</p>
        <p style={{ color: "#bd897d" }}>06 44 76 55 88</p>
        <p style={{ color: "#bd897d" }}>naitreensemble@outlook.fr</p>
      </div>
