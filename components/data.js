const data = [
  {
    ...
    content: [
      ...
      `Une technique de bercement au rebozo vous sera proposée puis un temps de massage ventral/cuisses vous sera offert ainsi qu'un temps d'accupression et de réflexologie fertilité.`,
  ...
  },
  {
    ...
    content: [
      ...
      `Un temps de massage du corps complet à l'huile chaude bio vous est offert. Ce massage respecte votre corps, votre intimité et votre bébé. Installée en fonction de vos besoins (ballon de grossesse, position latérale/dos, coussins, coussin d'allaitement) et recouverte d'une serviette, ce massage vous assure un confort idéal sur une table de massage chauffée.`,
  ...
  },
  {
    ...
    content: [
      ...
      `Un temps de réflexologie plantaire et/ou palmaire en fonction de vos besoins, accompagné d'une couverture douce sur le reste du corps.`,
      `Ce soin vous est proposé à partir du 2ème trimestre jusqu'à la fin de grossesse et peut se faire quotidiennement.`,
      `Il est aussi très adapté après l'accouchement, notamment pour les femmes qui ont du mal à lâcher prise ou qui n'aiment pas les massages du corps complet.`,
    ],
    prestations: ["à domicile", "en cabinet"],
    duration: "1h",
    price: "65 euros",
  ...
  },
  {
    ...
    content: [
      ...
      `L'ATELIER PAPA/PARENT COACH est un atelier prénatal dédié au couple autour des sujets suivants : la grossesse, les changements physiques et psychiques pour les deux parents, la création de lien avec bébé, les hormones, l'accouchement, la place du co-parent.`,
      ...
      `Nous débutons l'atelier autour d'un temps d'échanges accompagné d'une boisson chaude et des quelques gourmandises.`,
      ...
      `Puis, nous passons à une transmission pratique autour des différents outils adaptés à tous : rebozo, massages, ballon, postures,bercements, peigne, suspension...`,
      `Vous repartez également avec une liste d'indispensables à avoir pour la salle d'accouchement et la maternité.`,
      `C'est une véritable transmission à destination de TOUS LES FUTURS PARENTS qui vous permet de repartir avec des clés concrètes mais aussi de vivre un temps de bien être en couple ou en famille dans une ambiance intimiste. Un temps rempli de douceur, de tendresse, de bienveillance et parfois de beaucoup d'humour.
      `,
    ],
    prestations: ["à domicile", "en cabinet"],
    duration: "1h30",
