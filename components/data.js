 const data = [
  ...
  },
  {
    ...
    content: [
      ...
      `Un temps de massage exclusif et non invasif à l'huile chaude bio (première pression à froid, sans perturbateurs endocriniens) vous est offert. Ce massage respecte votre corps, votre intimité et votre bébé. Allongée sur le côté avec un coussin d'allaitement à disposition et recouverte d'une serviette délicate, ce massage vous assure un confort idéal sur une table de massage chauffée.`,
    ...
    duration: "1h15",
    price: "70 euros",
    infos: `Contre-indications :  fièvre, hypertension ou vaccin de moins de 48h. En cas de doute demander toujours l'avis de votre obstétricien ou sage-femme.`
  },
  {
    ...
    content: [
      ...
      `Ce soin comprend :`,
      `Un temps d'accueil autour d'une boisson chaude`,
      `Un temps de réflexologie donné par mes soins ou de transmission (si présence du co-parent) accompagné d'une couverture contenante et rassurante sur le reste du corps qui permet de relâcher les tensions et de s'ancrer.`,
